...
public record HighlightResponseDto(
        ...
        @Schema(description = "하이라이트 시작 X", example = "0.2134") double startX,
        @Schema(description = "하이라이트 시작 Y", example = "0.1234") double startY,
        @Schema(description = "하이라이트 끝 X", example = "0.1234") double endX,
        @Schema(description = "하이라이트 끝 Y", example = "0.1234") double endY,
