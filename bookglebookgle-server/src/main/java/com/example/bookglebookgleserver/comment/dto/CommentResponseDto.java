...
public record CommentResponseDto(
        ...
        @Schema(description = "선택영역 시작 X", example = "100") double startX,
        @Schema(description = "선택영역 시작 Y", example = "150") double startY,
        @Schema(description = "선택영역 끝 X", example = "300") double endX,
        @Schema(description = "선택영역 끝 Y", example = "200") double endY,
