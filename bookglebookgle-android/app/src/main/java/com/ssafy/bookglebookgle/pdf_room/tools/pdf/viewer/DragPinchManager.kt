...
internal class DragPinchManager(
    ...
    private val animationManager: AnimationManager,  // 로컬 AnimationManager 사용
    ...
    companion object {
        private const val TAG = "com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.DragPinchManager"
    }
