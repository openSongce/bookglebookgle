package com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer
...
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.annotation.PdfAnnotationHandler
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.exception.PageRenderingException
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.link.DefaultLinkHandler
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.link.LinkHandler
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.listener.Callbacks
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.listener.OnDrawListener
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.listener.OnErrorListener
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.listener.OnLoadCompleteListener
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.listener.OnLongPressListener
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.listener.OnPageChangeListener
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.listener.OnPageErrorListener
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.listener.OnPageScrollListener
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.listener.OnRenderListener
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.listener.OnTapListener
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.model.CharDrawSegments
...
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.model.PageModel
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.model.PagePart
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.model.PdfAnnotationModel
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.model.PdfChar
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.model.PdfLine
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.model.PdfWord
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.model.TextSelectionData
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.scroll.ScrollHandle
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.selection.PdfTextSelectionHelper
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.source.ByteArraySource
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.source.DocumentSource
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.source.FileSource
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.util.CanvasUtils
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.util.Constants
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.util.FitPolicy
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.util.MathUtils
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.util.SnapEdge
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.util.Util
import com.ssafy.bookglebookgle.pdf_room.tools.pdf.viewer.util.zoom
import com.ssafy.bookglebookgle.pdf_room.utils.log
...
//        }
        onDrawPagesNumbs.clear()
        val tempPagesPaginationIndexes = arrayListOf<Int>()
        val tempPageOffsets = arrayListOf<Float>()
        ...
        for (part in cacheManager?.pageParts ?: emptyList()) {
            ...
            if (!onDrawPagesNumbs.contains(page)) {
                onDrawPagesNumbs.add(page)
                tempPageOffsets.add(pdfFile!!.getPageOffset(page))
                tempPagesPaginationIndexes.add(pdfFile!!.getPaginationIndexFromPageIndex(page))
            }
        }
        // drawAnnotations() 호출
        annotationHandler.drawAnnotations(tempPagesPaginationIndexes, tempPageOffsets, canvas, zoom)

        currentPagesPaginationIndexes = tempPagesPaginationIndexes
        currentPageOffsets = tempPageOffsets
        currentZoom = zoom
